...
public class Controller {
    ...
    public void printAllMembers() {
        ...
        System.out.println(String.format("┃ %-4s │  %-25s │  %-18s │  %-13s │  %-23s │  %-10s │  %-7s │  %-7s │  %-18s │  %-10s │  %-10s │  %-15s │ ", "ID", "Navn", "Addresse", "Tlf", "Mail", "Fødselsdag", "Betalt", "Aktiv", "Konkurrencesvømmer", "Studerende", "Arkiveret", "Betalingsdato"));
        for (Swimmer swimmer : getSwimmerList()) {
            ...
            String s = String.format("┃ %-4s │  %-25s │  %-18s │  %-13s │  %-23s │  %-10s │  %-7s │  %-7s │  %-18s │  %-10s │  %-10s │  %-15s │ ", a, b, c, d, e, f, g, h, i, j, k, l);
